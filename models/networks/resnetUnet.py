...
class ResNetUNetAttn(nn.Module):
    def __init__(self, n_channel_in, n_class_out):
        super().__init__()
        ...
        #self.conv_up3 = convrelu(256 + 512, 512, 3, 1)
        self.conv_up3 = convrelu(256 + 640, 512, 3, 1)
        self.conv_up2 = convrelu(128 + 512, 256, 3, 1)
        self.conv_up1 = convrelu(64 + 256, 256, 3, 1)
        self.conv_up0 = convrelu(64 + 256, 128, 3, 1)
    ...
    def forward(self, input, attn_dec_out):
        ...
        #print(x.shape)
        #print(attn_dec_out.shape)

        # Concatenate the encoded input with the attention output
        x = torch.cat([x, attn_dec_out], dim=1)
        #print(x.shape)
